...
namespace daqser
{
...
#ifdef RX_PDM
    // PDM_Current Signals
    MakeSignedCANSignal(double, 0, 32, 0.01, 0.0) s_PDM_Current_Unreg_Amps{};
    MakeSignedCANSignal(double, 32, 32, 0.01, 0.0) s_PDM_Current_FiveVolt_Amps{};
#endif
#ifdef RX_WHEEL
    ...
    MakeSignedCANSignal(double, 0, 32, 1.0, -40.0) s_Coolant_Temp_Message_Coolant_Temp{};
    // Coolant_Flow_Message Signals
    MakeSignedCANSignal(double, 0, 32, 1.0, 0.0) s_Coolant_Flow_Message_Coolant_Flow{};
#endif
#ifdef RX_SHUTDOWN
...
#ifdef RX_PDM
    // PDM_Current
    daqser::set("PDM_Current.Unreg_Amps", (double)s_PDM_Current_Unreg_Amps);
    daqser::set("PDM_Current.FiveVolt_Amps", (double)s_PDM_Current_FiveVolt_Amps);
#endif
#ifdef RX_WHEEL
    // Wheel_Temp_Front
...
#ifdef RX_COOLANT
    // Coolant_Temp_Message
    daqser::set("Coolant_Temp_Message.Coolant_Temp", (double)s_Coolant_Temp_Message_Coolant_Temp);
    // Coolant_Flow_Message
    daqser::set("Coolant_Flow_Message.Coolant_Flow", (double)s_Coolant_Flow_Message_Coolant_Flow);
#endif
#ifdef RX_SHUTDOWN
    // Shutdown_Status
